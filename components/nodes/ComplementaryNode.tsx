...
interface ComplementaryNodeProps extends NodeProps {
  data: Record<string, never>;
}

const ComplementaryNode = ({ id, selected }: ComplementaryNodeProps) => {
    ...
    >
      <CardContent className="flex flex-col gap-3 p-0 pt-4">
        <div className="space-y-2 px-4">
          <div className="font-semibold text-sm">Complementary</div>
        </div>
